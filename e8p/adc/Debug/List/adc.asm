...
_0x0:
	.DB  0x41,0x44,0x43,0x3D,0x25,0x64,0x0
_0x2020003:
	.DB  0x80,0xC0
...
_main:
; .FSTART _main
; 0000 0011 ADCSRA|=(1<<7)|(1<<2)|(1<<1)|(1<<0);
	IN   R30,0x6
	ORI  R30,LOW(0x87)
	OUT  0x6,R30
...
; 0000 0016 
; 0000 0017     ADCSRA|=(1<<6);
	SBI  0x6,6
; 0000 0018     delay_ms(500);
	LDI  R26,LOW(500)
	LDI  R27,HIGH(500)
	CALL _delay_ms
; 0000 0019     ADC_buffer=ADCL+(ADCH<<8);
	IN   R30,0x4
	LDI  R31,0
	MOVW R26,R30
	IN   R30,0x5
...
; 0000 001A     lcd_clear();
	CALL _lcd_clear
; 0000 001B     sprintf(lcd_buffer,"ADC=%d",ADC_buffer);
